...
const TOPIC_CATEGORIES = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "deals", label: "M&A & VC", description: "Levées de fonds, acquisitions stratégiques, IPO et mouvements de capital qui signalent les tendances.", keywords: ["M&A", "acquisition", "levée de fonds", "VC", "funding", "série A", "bourse", "valorisation"] },
    ]
  },
  {
    id: "world",
